...
class TestFewShotTextPromptTemplate(unittest.TestCase):
    ...
    def test_format(self):
        ...
        p3 = FewShotTextPromptTemplate("{prompt}")
        ...
        p4 = FewShotTextPromptTemplate("{prompt}")
        v4 = p4.format(prompt="你好！")
        print(f"v4={v4}")
        self.assertEqual("你好！", v4)

        p5 = FewShotTextPromptTemplate("This is a sample prompt {f1} and {f2} and {f3}.")
        v5 = p5.format(f1="v1", f2="v2", f3="v3")
        print(f"v5={v5}")
        self.assertEqual("This is a sample prompt v1 and v2 and v3.", v5)

        p6 = FewShotTextPromptTemplate("This is a sample prompt {f1} and {f2} and {f3}.")
        with self.assertRaises(KeyError):
            p6.format(f1="v1", f2="v2")

        p7 = FewShotTextPromptTemplate(
